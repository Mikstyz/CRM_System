...
#### GenerateFilledPDF
- **Описание**: Генерирует заполненный PDF-документ на основе данных о студенте, группе и работе.
- **Входные данные**:
  ```json
  {
    "StudentName": "string",
...
200: Успех — PDF-документ сгенерирован.{
  "Code": 200,
  "File": "string" // base64-строка или путь к файлу
}


500: Ошибка — не удалось сгенерировать PDF (например, неверные данные, студент/группа не найдены или сбой сервера).{
  "Code": 500,
  "Error": "описание ошибки"
}
